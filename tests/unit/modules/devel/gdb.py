...
class GdbTest(Test):
    ...
    def setUp(self):
        self.return99_binary_path = os.path.join(self.workdir, "return99")
        ...
        process.system(
            f"gcc -O0 -g {return99_source_path} -o {self.return99_binary_path}"
        )

        self.segfault_binary_path = os.path.join(self.workdir, "segfault")
        ...
        process.system(
            f"gcc -O0 -g {segfault_source_path} -o {self.segfault_binary_path}"
        )
