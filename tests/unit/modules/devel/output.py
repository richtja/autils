...
from autils.devel import output
...
class ProgressBarTest(unittest.TestCase):
    ...
    def test_update_progress_bar_empty(self):
        ...
        pb.current_amount = 0
        pb._update_progress_bar()  # pylint: disable=W0212
    ...
    @patch("sys.stdout")
    def test_draw_no_change(self, mock_stdout):  # pylint: disable=R6301
    ...
    @patch("sys.stdout")
    def test_draw_with_change(self, mock_stdout):  # pylint: disable=R6301
